        ...
        <div class="content-container">
          <div class="content-row">
            <span class="row-title"
              >${translate('widgets.swap-form.fusion-info.slippage-tolerance')}</span
            >
            <div
              @click="${() => dispatchEvent(this, 'openSlippageSettings', null)}"
              class="row-content row-slippage"
            >
          ...
          <div class="content-row">
            <span class="row-title"
              >${translate('widgets.swap-form.fusion-info.auction-time')}</span
            >
            <div
              @click="${() => dispatchEvent(this, 'openAuctionTimeSettings', null)}"
              class="row-content row-slippage"
            >
          ...
          <div class="content-row">
            ...
            <div class="row-content">${observe(this.minReceiveView$)}</div>
          </div>
          <div class="content-row">
