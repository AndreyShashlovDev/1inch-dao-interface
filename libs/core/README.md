...
- **[lit](src/lib/lit)**: A submodule designed to simplify various aspects of working with Lit. It
  also implements an i18n translation system compatible with Lit.
...
The `@one-inch-community/core` module is focused on solving utility-level challenges in the
development process. It ensures smooth interaction between the application and its environment,
manages global styling and localization, and provides essential tools to optimize and streamline
various tasks. While it does not include business logic, it is foundational for creating a cohesive
